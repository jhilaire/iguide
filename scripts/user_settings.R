...
u_variableDefinition <- list(
  ...
  "energy_tpes_IEA_pc" = c(type="x", factor=1,     transform="",    demean=TRUE,  firstdiff=FALSE),
  "energy_fec_IEA_pc"  = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "gini_SWIID"         = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "pop_UN"             = c(type="x", factor=1e-9,  transform="log", demean=TRUE,  firstdiff=FALSE), 
  "lex_WB"             = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),         
  "gini_WB"            = c(type="x", factor=1,     transform="",    demean=TRUE,  firstdiff=FALSE),
  "urban_WB"           = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "pop_density_WB"     = c(type="n", factor=1e-3,  transform="log", demean=TRUE,  firstdiff=FALSE), 
  "share_gdp_agri_WB"  = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "share_gdp_ind_WB"   = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "share_gdp_serv_WB"  = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "share_gdp_trade_WB" = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "inst_WGI"           = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "ratio_ee"           = c(type="x", factor=1,     transform="",    demean=TRUE,  firstdiff=FALSE),
  "ratio_ef"           = c(type="n", factor=1,     transform="log", demean=TRUE,  firstdiff=FALSE),
  "gdp_ppp_PWT"        = c(type="x", factor=1e-9,  transform="log", demean=TRUE,  firstdiff=FALSE),
  "energy_tpes_IEA"    = c(type="x", factor=1e-9,  transform="log", demean=TRUE,  firstdiff=FALSE),
  "energy_fec_IEA"     = c(type="x", factor=1e-9,  transform="",    demean=TRUE,  firstdiff=FALSE),
  #---- (f) numerical variable used for fitting only --------------------
